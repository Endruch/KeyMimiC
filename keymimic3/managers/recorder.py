...
# NOTE: 0x20 is LLKHF_ALTDOWN, not LLKHF_LOWER_IL_INJECTED (that's 0x02) -
# using 0x20 here previously meant any real physical key pressed while Alt
# was held (WM_SYSKEYDOWN/UP - Alt+F4, menu accelerators, Alt-modified game
# binds) was misidentified as injected and silently dropped from recordings.
